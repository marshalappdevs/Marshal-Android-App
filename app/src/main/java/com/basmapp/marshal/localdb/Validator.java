...
class Validator {
    ...
    private static final int TYPE_NUMERIC_LONG_POSITIVE = 12;
    private static final int TYPE_STRING = 13;
    private static final int TYPE_FOREIGN_KEY_ENTITY = 14;
    private static final int TYPE_DATE = 15;

    private static final String ERROR_CANNOT_BE_NULL = "field must contain a value";
    private static final String ERROR_WRONG_VALIDATION_CODE = "wrong validation code. Call to the programmer";
    private static final String ERROR_NOT_NUMERIC = "value must be numeric";
    private static final String ERROR_NOT_POSOTIVE = "number must be positive";

    private static final String NULL_STRING = "";

    static void setAttribute(Object setterOwner, Method setter,
