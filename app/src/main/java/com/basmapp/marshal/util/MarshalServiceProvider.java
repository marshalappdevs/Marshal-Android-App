...
//    public static final String GET_ALL_RATINGS                      = API_BASE_URL + "ratings";
    ...
    public static final String POST_GCM_REGISTER_NEW_DEVICE         = API_BASE_URL + "fcm/register/";
    public static final String PUT_GCM_REGISTER_EXIST_DEVICE        = API_BASE_URL + "fcm/register/";
    public static final String DELETE_GCM_UNREGISTER_DEVICE         = API_BASE_URL + "fcm/unregister/";
    ...
    public static final String GET_GCM_REGISTRATION = API_BASE_URL + "fcm/registrations/";
