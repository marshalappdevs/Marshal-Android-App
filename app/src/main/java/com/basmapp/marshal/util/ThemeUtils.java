...
public class ThemeUtils {
    ...
    public static void updateTheme(AppCompatActivity appCompatActivity) {
        int[] PRIMARY_COLORS = new int[]{
                ContextCompat.getColor(appCompatActivity, R.color.red_primary_color),
                ContextCompat.getColor(appCompatActivity, R.color.pink_primary_color),
                ContextCompat.getColor(appCompatActivity, R.color.purple_primary_color),
                ContextCompat.getColor(appCompatActivity, R.color.deep_purple_primary_color),
                ContextCompat.getColor(appCompatActivity, R.color.indigo_primary_color),
                ContextCompat.getColor(appCompatActivity, R.color.blue_primary_color),
                ContextCompat.getColor(appCompatActivity, R.color.light_blue_primary_color),
                ContextCompat.getColor(appCompatActivity, R.color.cyan_primary_color),
                ContextCompat.getColor(appCompatActivity, R.color.teal_primary_color),
                ContextCompat.getColor(appCompatActivity, R.color.green_primary_color),
                ContextCompat.getColor(appCompatActivity, R.color.light_green_primary_color),
                ContextCompat.getColor(appCompatActivity, R.color.lime_primary_color),
                ContextCompat.getColor(appCompatActivity, R.color.yellow_primary_color),
                ContextCompat.getColor(appCompatActivity, R.color.amber_primary_color),
                ContextCompat.getColor(appCompatActivity, R.color.orange_primary_color),
                ContextCompat.getColor(appCompatActivity, R.color.deep_orange_primary_color),
                ContextCompat.getColor(appCompatActivity, R.color.brown_primary_color),
                ContextCompat.getColor(appCompatActivity, R.color.grey_primary_color),
                ContextCompat.getColor(appCompatActivity, R.color.blue_grey_primary_color),
                ContextCompat.getColor(appCompatActivity, R.color.black_primary_color)
        };

        int[] ACCENT_COLORS = new int[]{
                ContextCompat.getColor(appCompatActivity, R.color.red_accent_color),
                ContextCompat.getColor(appCompatActivity, R.color.pink_accent_color),
                ContextCompat.getColor(appCompatActivity, R.color.purple_accent_color),
                ContextCompat.getColor(appCompatActivity, R.color.deep_purple_accent_color),
                ContextCompat.getColor(appCompatActivity, R.color.indigo_accent_color),
                ContextCompat.getColor(appCompatActivity, R.color.blue_accent_color),
                ContextCompat.getColor(appCompatActivity, R.color.light_blue_accent_color),
                ContextCompat.getColor(appCompatActivity, R.color.cyan_accent_color),
                ContextCompat.getColor(appCompatActivity, R.color.teal_accent_color),
                ContextCompat.getColor(appCompatActivity, R.color.green_accent_color),
                ContextCompat.getColor(appCompatActivity, R.color.light_green_accent_color),
                ContextCompat.getColor(appCompatActivity, R.color.lime_accent_color),
                ContextCompat.getColor(appCompatActivity, R.color.yellow_accent_color),
                ContextCompat.getColor(appCompatActivity, R.color.amber_accent_color),
                ContextCompat.getColor(appCompatActivity, R.color.orange_accent_color),
                ContextCompat.getColor(appCompatActivity, R.color.deep_orange_accent_color),
        };
